...
## Description
Where It's @ is a frontend project built with **React** for displaying local music events.  
Users can browse events, navigate between pages, and purchase tickets with generated ticket IDs.  
The app is responsive, accessible, and interacts with a provided events API.
...
### Forklaring i valg av bibliotek til oppgavebesvarelsen
